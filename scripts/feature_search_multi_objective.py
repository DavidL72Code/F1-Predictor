...
def build_candidates(strategy: str, min_k: int, max_k: int, random_samples: int, seed: int):
...
def main():
    ...
    parser.add_argument("--strategy", choices=["exhaustive", "min_k_max_k", "random"], default="min_k_max_k")
    ...
    candidates = build_candidates(args.strategy, args.min_k, args.max_k, args.random_samples, args.seed)
